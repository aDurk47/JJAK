...
public class BattleSystem : MonoBehaviourPun
{
    ...
    IEnumerator SetupBattle()
    {
        ...
        enemyUnit = Instantiate(enemyPrefabs[rand.Next(enemyPrefabs.Length)], enemyBattleStation).GetComponent<Unit>();
    ...
    IEnumerator EnemyTurn()
    {
        ...
        double dmg = rand.Next(enemyUnit.damage - 5, enemyUnit.damage + 5);
    ...
    public void ChangeDescription(int spellnumber)
    {
        ...
        switch(spellnumber)
        {
            ...
            default:
                ...
                if(spell.stun) temp += "\nStun";
                if(spell.turnsCost > 1) temp += "\nCool Down: " + (spell.turnsCost - 1) + "turn";
    ...
    IEnumerator EndBattle()
    {
        ...
        NetworkManager.instance.loadSinglePlayer(false);
    }
}
